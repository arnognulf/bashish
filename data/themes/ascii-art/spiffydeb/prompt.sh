...
PS1="${EMBED}${ESC}[1;3${BASHISH_COLOR0}m${UNEMBED}${USER}${EMBED}${ESC}[2m${UNEMBED}@${EMBED}${ESC}[1;3${BASHISH_COLOR0}m${UNEMBED}$HOSTNAME${EMBED}${ESC}[2m${UNEMBED}:${BASHISH_CWD}${EMBED}${ESC}[1;3${BASHISH_COLOR0}m${UNEMBED}\$${EMBED}${ESC}[0m${UNEMBED} "
}
_bashish_prompt
