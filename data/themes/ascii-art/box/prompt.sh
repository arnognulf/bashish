...
test "x${RCS_PS1}" != x && RCS_PS1="${ESC}[0;3${BASHISH_COLOR0}m|${ESC}[${BOLD};${BRIGHTFG}${BASHISH_COLOR0}m${RCS_PS1}${ESC}[0;3${BASHISH_COLOR0}m"
...
${ESC}[3${BASHISH_COLOR0}m]\
${ESC}[2C[\
${ESC}[9${BASHISH_COLOR0}m${UNEMBED}$BASHISH_CWD${EMBED}${RCS_PS1}\
${ESC}[3${BASHISH_COLOR0}m]\
