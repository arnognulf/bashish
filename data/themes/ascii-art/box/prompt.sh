...
local BASHISH_CWD=`_bashish_prompt_cwd $SHELLNAME "${ESC}[${NORMAL};${FG}${BASHISH_COLOR0}m" "${ESC}[${NORMAL};${BRIGHTFG}${BASHISH_COLOR0}m" 43`
case "${UID}" in
0)
PS1="${EMBED}\
${ESC}[?7l\
...
${ESC}[${NORMAL};${BRIGHTFG}${BASHISH_COLOR0}m${BASHISH_DA}${BASHISH_C4}${BASHISH_D9} ${EMBED}\
${ESC}["$COLUMNS"G\
...
${ESC}[${NORMAL};${FG}${BASHISH_COLOR0}m]\
${ESC}8${UNEMBED}\
${ESC}[${NORMAL};${BRIGHTFG}${BASHISH_COLOR0}m${BASHISH_DA}`_bashish_prompt_fillx ${BASHISH_C4} 2`${BASHISH_BF}
${ESC}[${NORMAL};${BRIGHTFG}${BASHISH_COLOR0}m${BASHISH_B3} ${EMBED}\
${ESC}["$COLUMNS"G\
${ESC}[${NORMAL};${FG}${BASHISH_COLOR0}m${BASHISH_B3}\
${ESC}[3G\
${ESC}[0m${UNEMBED}"
