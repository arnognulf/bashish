...
test "x${RCS_PS1}" != x && RCS_PS1="${EMBED}${ESC}[0;3${BASHISH_COLOR0};2m${UNEMBED}(${EMBED}${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BOLD}m${UNEMBED}${RCS_PS1}${EMBED}${ESC}[0;3${BASHISH_COLOR0};2m${UNEMBED})${EMBED}${ESC}[0m${UNEMBED} "
local ROOT=""
...
${ESC}[0G\
${ESC}[${BRIGHTFG}${BASHISH_COLOR0};4${BASHISH_COLOR0};${BOLD}m$FADE\
${ESC}[${BRIGHTFG}7;4${BASHISH_COLOR0};${BOLD}m ${PROMPTSTR}\
${ESC}[0m\
${ESC}[3${BASHISH_COLOR0};40m$FADE\
${ESC}[${BRIGHTFG}7;40;${BOLD}m ${DATE} ${TIME}\
${ESC}[9${BASHISH_COLOR0}m\
${ESC}[6D:\
${ESC}[2C:\
${ESC}[2C${ESC}[0m
${EMBED}${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BOLD}m${UNEMBED}"`_bashish_prompt_cwd $SHELLNAME "${ESC}[0;3${BASHISH_COLOR0}m" "${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BOLD}m" \`expr $COLUMNS / 2\``"${EMBED}${ESC}[0;3${BASHISH_COLOR0}m${UNEMBED}/${EMBED}\
