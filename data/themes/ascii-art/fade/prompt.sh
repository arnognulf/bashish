...
${ESC}[2C:\
${ESC}[2C${ESC}[0m
${EMBED}${ESC}[3${BASHISH_COLOR0};1m${UNEMBED}"`_bashish_prompt_cwd "${ESC}[0;3${BASHISH_COLOR0}m" "${ESC}[3${BASHISH_COLOR0};1m" \`expr $COLUMNS / 2\``"${EMBED}${ESC}[0;3${BASHISH_COLOR0}m${UNEMBED}/${EMBED}\
