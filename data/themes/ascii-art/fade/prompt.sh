...
test "x${RCS_PS1}" != x && RCS_PS1="${EMBED}${ESC}[0;${NORMAL};${FG}${BASHISH_COLOR0};2m${UNEMBED}(${EMBED}${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BOLD}m${UNEMBED}${RCS_PS1}${EMBED}${ESC}[0;${NORMAL};${FG}${BASHISH_COLOR0};2m${UNEMBED})${EMBED}${ESC}[0m${UNEMBED} "
local ROOT=""
test "x${UID}" = x0 && ROOT="$EMBED${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BOLD}m$UNEMBED#$EMBED${ESC}[0m$UNEMBED "

PS1="\
${ESC}[0G\
${ESC}[40m`_bashish_prompt_fillx \" \"`\
${ESC}[0G\
${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BG}${BASHISH_COLOR0};${BOLD}m$FADE\
${ESC}[${BRIGHTFG}7;${BG}${BASHISH_COLOR0};${BOLD}m ${PROMPTSTR}\
${ESC}[0m\
${ESC}[${NORMAL};${FG}${BASHISH_COLOR0};${BG}0m$FADE\
${ESC}[${BRIGHTFG}7;${BG}0;${BOLD}m ${DATE} ${TIME}\
${ESC}[${BRIGHTFG}${BASHISH_COLOR0}m\
${ESC}[6D:\
${ESC}[2C:\
${ESC}[2C${ESC}[0m
${EMBED}${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BOLD}m${UNEMBED}"`_bashish_prompt_cwd $SHELLNAME "${ESC}[0;${NORMAL};${FG}${BASHISH_COLOR0}m" "${ESC}[${BRIGHTFG}${BASHISH_COLOR0};${BOLD}m" \`expr $COLUMNS / 2\``"${EMBED}${ESC}[0;${NORMAL};${FG}${BASHISH_COLOR0}m${UNEMBED}/${EMBED}\
