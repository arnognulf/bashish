...
test "x$BASHISH_COLOR0" = x && eval $(_bashish_prompt_parsecolors blue white)
test "x$BASHISH_COLOR1" = x && eval $(_bashish_prompt_parsecolors "$1" white)
...
${ESC}[K\
${ESC}${RESTORECUR}\
${ESC}[${FG}${BASHISH_COLOR0};${BRIGHTBG}${WHITE}${SETCOLOR}\
${UNEMBED}\$\
${EMBED}\
${ESC}[${NORMAL}${SETCOLOR}\
${UNEMBED} "
